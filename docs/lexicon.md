...
This is the English on the site. Code may keep old identifiers (`lights`, `chipWord`, `#favorStrip`). Those names must never appear in UI, About, Math, Annex, aria, titles, or agent copy aimed at Mark.

If a sentence would only make sense to the person who wrote the function, rewrite it.

## The two rows

| Say | Never say | What it is |
|---|---|---|
| **Regime** / **regime components** / **the five** | lights, chips, five words (as the name of the boxes) | Liquidity, Rates, Growth, Inflation, Risk |
| **Reading** / **state** | “the word” as the name of the box | What a component says today: Tight, Hot, Leaning strong |
...
Needle, tap, lean, in / mixed / out, chevron — those stay. They are gauge language, not code.

## Rules

- A reading is a property of a component. Do not say “the five words.” Say “the five components” and then “Liquidity is Tightening.”
